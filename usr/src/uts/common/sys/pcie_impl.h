...
extern void pcie_apply_plat_props(dev_info_t *dip);
extern void pcie_init_plat(dev_info_t *dip);
extern void pcie_fini_plat(dev_info_t *dip);
extern boolean_t pcie_plat_preserve_config(dev_info_t *dip);
extern boolean_t pcie_plat_owns_pcie_caps(dev_info_t *dip);
extern boolean_t pcie_plat_owns_aer(dev_info_t *dip);
